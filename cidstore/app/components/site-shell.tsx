...
const navItems = [
  ...
  { label: "Asset", href: "/asset", icon: Wallet },
  { label: "Trade", href: "/trade", icon: CreditCard },
            ...
            <div className="hidden items-center gap-3 md:flex">
              ...
              {isCustomerLoggedIn ? (
                <>
                  <Link
                    href="/account"
                    className="flex items-center gap-3 rounded-full border border-cyan-400/30 bg-cyan-500/10 px-3 py-2 transition hover:border-cyan-400/60"
                  >
                    <span
                      className="h-2.5 w-2.5 rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(74,222,128,0.8)]"
                      aria-hidden="true"
                    />
                    ...
                    <div className="flex flex-col leading-none text-left">
                      ...
                      <span className="mt-1 text-sm font-semibold text-cyan-50">
                        Account
                      </span>
                    </div>
                  </Link>
                ...
                {isCustomerLoggedIn ? (
                  <>
                    <Link
                      href="/account"
                      onClick={() => setMobileMenuOpen(false)}
                      className="block rounded-2xl border border-cyan-400/30 bg-cyan-500/10 p-3"
                    >
      ...
      <footer className="border-t border-white/10 bg-slate-950/80">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-8 rounded-[28px] border border-cyan-400/20 bg-gradient-to-r from-slate-900/80 to-slate-900/60 p-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h3 className="mt-2 text-2xl font-semibold text-white">
                Your crypto exchange dashboard.
              </h3>
            </div>
          ...
          <div className="mt-8 flex flex-col gap-4 border-t border-white/10 pt-6 text-sm text-slate-400 md:flex-row md:items-center md:justify-between">
            <p>© 2026 CID Store. Crypto exchange platform.</p>
